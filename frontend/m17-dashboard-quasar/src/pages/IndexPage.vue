          ...
          <q-markup-table>
            ...
            <tbody>
              <tr v-for="station in station_rows" :key="station">
                ...
                <td class="gt-xs text-left" style="max-width:80px">{{ station.destination }}</td>
                <td class="gt-xs text-left" style="max-width:50px">{{ station.mode }}</td>
                <td class="gt-xs text-left" style="max-width:80px">{{ station.via }}</td>
